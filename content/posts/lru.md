...
A tabela a seguir está organizada do livro mais recentemente utilizado (à esquerda) para o menos recentemente utilizado (à direita).
...
1. A estrutura para manter a ordem de acesso dos dados, geralmente, é uma **Lista Duplamente Ligada** com o *head* armazenando o nó **mais recentemente acessado** e o *tail* o **menos recentemente acessado**.
